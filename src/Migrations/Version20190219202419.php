 ...
 */
final class Version20190219202419 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clients ADD CONSTRAINT FK_C82E747294869C FOREIGN KEY (article_id) REFERENCES tag (id)');
